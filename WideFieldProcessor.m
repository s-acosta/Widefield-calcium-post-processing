...
%                 obj.Options.Mode = 'manual';
    ...
    methods (Access = public)
        ...
        function computeDFF(obj)
            ...
            computeProperties(obj, image_raw)
    ...
    methods (Access = public, Static)
        ...
        function [traces, pixel_idx, mask_mat] = getRegionTraces(mat, mask_struct, ...
                n_pixels, region, side)
            ...
            if nargin == 5
                ...
                switch side
                    ...
                    otherwise
                        disp('Please choose right or left')
                        return
                end
    ...
    methods (Access = public)
        ...
        function showMapRegions(obj, mat, ax)
            
            min_val = 0;
            max_val = prctile(mat(:), 99);
            ...
            imagesc(ax, mat, 'AlphaData', mask_mat)
            set(ax, 'CLim', [min_val max_val]);
           
            hold on
            
            fn = fieldnames(obj.mask);
            for i = 3:numel(fn)
                
                layer = obj.mask.(fn{i}) ;
                layer(~obj.mask.Window) = 0;
                contour(ax, layer, [1 1], 'Color', 'w', 'LineWidth', 2);
                hold on
